const Footer = () => {
  return (
    <footer className="bg-neutral text-neutral-content pt-12 pb-8">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm opacity-80">
                ...
                <span>123 Library Lane, Bibliopolis, BK 45678</span>
              </li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="btn btn-circle btn-ghost btn-sm hover:bg-primary hover:text-white transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-2.25c0-1.187.321-2 2.052-2h2.306v-4.029c-.398-.053-1.764-.171-3.354-.171-3.321 0-5.594 2.028-5.594 5.753v2.697z" />
                </svg>
              </a>
              <a href="#" className="btn btn-circle btn-ghost btn-sm hover:bg-primary hover:text-white transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-6">
              ...
              <div className="join">
                <input className="input input-bordered input-sm join-item bg-neutral-focus" placeholder="Email Address" />
        ...
        <div className="border-t border-white/10 pt-8 mt-8 text-center text-xs opacity-60">
